...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_adress,receiver='5003 Port Sahibi', amount=1000) # İşlem eklendi bu olay çeşitli fonksiyonlar eklnerek blockchainde tetiklenebilir ve blockchaine işlevsellik katabilir tabi burada minin yapıldığı için işlem eklendi  yani ödül verildi
...
# Runnuing the app
app.run(host= '0.0.0.0', port = 5003)  # port numarası verilerek işlemlerin farklı düğümlerde de gözükmesi yani merkeziyetsizleştirimesi gerekir 
